...
namespace Engine
{
    //In .dot framework there is two ways to generate random numbers.
    //1) Deterministic: It follows kind of a detectable pattern
    //2) Non-Deterministic: This approach is one where you can't determine the pattern
    
    //This is the more complex version (non-deterministic)
    public static class RandomNumberGenerator
    {
        ...
        // Simple version, with less randomness (deterministic).
        //
