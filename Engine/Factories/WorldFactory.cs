...
{
    //we only want to use this inside the engine project, by default c# classes are internal if you don't give it anything
    internal static class WorldFactory
    {
        //our function to create a world
        internal static World CreateWorld()
        {
            World newWorld = new World();
            
            //this is how we will add all our locations into the world object...(basically kinda what you did in the "adding location" section of GameSession)
            ...
            newWorld.AddLocation(2, 0, "Spider Forest",
                ...
                "SpiderForest.png");
            newWorld.LocationAt(2,0).AddMonster(3, 0);
